...
class Genotype(object):
    ...
    def __init__(self, listechromosome= None ): #inputData,
        ...
        '''np.random.randint(int(inputData['buy_range_von']),
        ...
        '''np.random.randint(int(inputData['buy_stoplos_von']),
        ...
        '''np.random.randint(int(inputData['sell_stoplos_von']),
        ...
        if listechromosome is None:
            ...
            #print('Genotyp ChromosomeI: ' + str(self.verkaufProzent))
